...
public class RouteConfig {
        ...
        public static void configurarRotas(PacienteApi pacienteApi, ImunizacaoApi imunizacaoApi, VacinaApi vacinaApi,
                ...
                Spark.get("/vacinas/consultar/idade_maior/:meses",
                                vacinaApi.consultarTodasVacinasRecomendadasAcimaIdade);
                ...
                Spark.get("/estatisticas/proximas_imunizacoes/paciente/:id",
                                estatisticaApi.qtdeVacinasProximasPorPaciente);
                Spark.get("/estatisticas/imunizacoes_atrasadas/paciente/:id",
                                estatisticaApi.qtdeVacinasAtrasadasPorPaciente);
                Spark.get("/estatisticas/imunizacoes/idade_maior/:meses", estatisticaApi.qtdeVacinasAcimaDeIdade);
                Spark.get("/estatisticas/vacinas/nao_aplivacaveis/paciente/:id",
                                estatisticaApi.qtdeVacinasNaoAplicaveis);
        }
}